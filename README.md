...
This format leads to **easier to read commit history**. For more information, read the [Conventional Commits specification](https://www.conventionalcommits.org/en/v1.0.0/).
