...
from ...caregivers import factories as caregiver_factories
from ...patients import factories as patient_factories
from ...patients.models import RelationshipStatus
...
class TestCaregiverPermissionsView:
    ...
    def test_no_caregiver_username(self, api_client: APIClient, admin_user: User) -> None:
        ...
        assert response.status_code == status.HTTP_403_FORBIDDEN
        assert "must provide an 'Appuserid'" in str(response.data['detail'])
