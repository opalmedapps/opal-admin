...
def test_insert_hospital_identifiers() -> None:
    ...
    rvh = hospital_factories.Site(code='RVH')
    mgh = hospital_factories.Site(code='MGH')
    mch = hospital_factories.Site(code='MCH')
...
def test_initialize_new_patient() -> None:
    ...
    legacy_patient = legacy_utils.initialize_new_patient(
        patient,
        [
            (hospital_factories.Site(code='RVH'), '9999995', True),
            (hospital_factories.Site(code='MGH'), '7654321', True),
            (hospital_factories.Site(code='MCH'), '1234567', False),
        ],
        self_caregiver=None,
    )
