...
class Command(BaseCommand):
    ...
    def _get_respondents_sync_err(
        ...
        Args:
            legacy_respondents (List[Tuple]): Django's `Users'` first and last names filtered by `username`
            django_respondents (List[Tuple]): Legacy's `answerQuestionnaire.respondentUsername` respondents' names
