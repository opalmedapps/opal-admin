# Generated by Django 3.2.13 on 2022-07-07 20:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='security_answers', to='caregivers.caregiverprofile', verbose_name='Caregiver Profile')),
                ...
                ('question_fr', models.CharField(max_length=100, null=True, verbose_name='Question')),
                ('answer', models.CharField(max_length=128, verbose_name='Answer')),
                ('answer_en', models.CharField(max_length=128, null=True, verbose_name='Answer')),
                ('answer_fr', models.CharField(max_length=128, null=True, verbose_name='Answer')),
            ],
            options={
