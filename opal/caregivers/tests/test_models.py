...
def test_caregiverprofile_factory() -> None:
    ...
    profile = factories.CaregiverProfile.create()
    profile.full_clean()
...
def test_caregiverprofile_factory_multiple() -> None:
    ...
    profile = factories.CaregiverProfile.create()
    profile2 = factories.CaregiverProfile.create()
...
def test_caregiverprofile_user_limited() -> None:
    ...
    clinical_staff = user_factories.User.create()
...
def test_caregiverprofile_legacy_id_unique() -> None:
    ...
    factories.CaregiverProfile.create(legacy_id=1)
...
def test_caregiverprofile_non_existing_legacy_id() -> None:
    ...
    factories.CaregiverProfile.create(legacy_id=None)
    factories.CaregiverProfile.create(legacy_id=None)
...
def test_security_question_str() -> None:
    ...
    question = factories.SecurityQuestion.create()
...
def test_security_question_factory_multiple() -> None:
    ...
    question = factories.SecurityQuestion.create()
    question2 = factories.SecurityQuestion.create()
...
def test_security_answer_str() -> None:
    ...
    answer = factories.SecurityAnswer.create()
    caregiver = user_factories.Caregiver.create(first_name='first_name', last_name='last_name')
    profile = CaregiverProfile()
    profile.user = caregiver
    answer.user = profile
...
def test_security_answer_factory_multiple() -> None:
    ...
    answer = factories.SecurityAnswer.create()
    answer2 = factories.SecurityAnswer.create()
...
def test_device_same_caregiver_same_device() -> None:
    ...
    caregiver = factories.CaregiverProfile.create(id=1)
    factories.Device.create(caregiver=caregiver, device_id='1a2b3c')
...
def test_device_diff_caregivers_same_device() -> None:
    ...
    caregiver1 = factories.CaregiverProfile.create()
    caregiver2 = factories.CaregiverProfile.create()
    factories.Device.create(caregiver=caregiver1, device_id='1a2b3c')
    factories.Device.create(caregiver=caregiver2, device_id='1a2b3c')
...
def test_device_same_caregiver_diff_devices() -> None:
    ...
    factories.Device.create(caregiver=caregiver, device_id='1a2b3c')
    factories.Device.create(caregiver=caregiver, device_id='a1b2c3')


def test_device_push_token_length() -> None:
    """Ensure a device push token can't be greater than 256 characters long."""
    caregiver = factories.CaregiverProfile.create(id=1)
    device = factories.Device.create(caregiver=caregiver)
...
def test_device_modified_datatype() -> None:
    ...
    caregiver = factories.CaregiverProfile.create(id=1)
    device = factories.Device.create(caregiver=caregiver, device_id='1a2b3c')
...
def test_registrationcode_str() -> None:  # pylint: disable-msg=too-many-locals
    ...
    registration_code = factories.RegistrationCode.create()
...
def test_registrationcode_factory_multiple() -> None:
    ...
    code = factories.RegistrationCode.create()
    code2 = factories.RegistrationCode.create(code='test')
...
def test_registrationcode_code_unique() -> None:
    ...
    with assertRaisesMessage(IntegrityError, "Duplicate entry 'code12345678' for key 'code'"):
        factories.RegistrationCode.create(relationship=registration_code.relationship)
...
def test_registrationcode_codes_length_lt_min() -> None:
    ...
    registration_code = factories.RegistrationCode.create(code='123456')
...
class TestEmailVerification:
    ...
    def test_factory(self) -> None:
        ...
        email_verification = factories.EmailVerification.create()
