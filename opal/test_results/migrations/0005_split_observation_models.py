    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_abnormal', models.CharField(choices=[('L', 'Low'), ('N', 'Normal'), ('H', 'High')], default='N', max_length=1, verbose_name='Abnormal Flag')),
                ('general_test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lab_observations', to='test_results.generaltest', verbose_name='General Test')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('general_test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pathology_observations', to='test_results.generaltest', verbose_name='General Test')),
            ],
            options={
