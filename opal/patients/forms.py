        ...
        **kwargs: Any,
        ...
        self.helper.layout = Layout(
            Row(
                ...
                CrispyField('type', wrapper_class='col-md-6'),
                CrispyField('start_date', wrapper_class='col-md-6'),
                CrispyField('status', wrapper_class='col-md-6'),
                CrispyField('end_date', wrapper_class='col-md-6'),
