...
class PatientFilter(django_filters.FilterSet):
    """
    This `PatientFilter` declares filters for the `Search Patient Settings` page.
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        """
        Initialize the filter and set the form layout for the search area of the "Patient Settings" page.
    ...
    def filter_queryset(self, queryset: QuerySet[Patient]) -> QuerySet[Patient]:
        ...
        if card_type == constants.MedicalCard.MRN.name:
            ...
            queryset = queryset.filter(
                hospital_patients__site=site_obj,
