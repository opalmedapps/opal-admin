...
from opal.patients.table import PatientTable
...
class FetchPatientView(View):
    ...
    def post(self, request: Any) -> HttpResponse:
        ...
        if (request.POST['medical_type'] == 'ramq'):
            patient_parameters = {
                'medicareNumber': request.POST['medical_number'],
            }
        else:
            patient_parameters = {'mrn': request.POST['medical_number'], 'site': request.POST['site_code']}
        ...
        patient_data = [
            {
                'first_name': patient_records['firstName'],
                'last_name': patient_records['lastName'],
                'date_of_birth': patient_records['dateOfBirth'],
            },
        ]
        table = PatientTable(patient_data)
