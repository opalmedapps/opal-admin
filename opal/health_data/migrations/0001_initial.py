    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('BM', 'Body Mass (kg)'), ('TMP', 'Body Temperature (°C)'), ('HR', 'Heart Rate (bpm)'), ('HRV', 'Heart Rate Variability (ms)'), ('SPO2', 'Oxygen Saturation (%)'), ('BP', 'Blood Pressure (mmHg)')], max_length=4, verbose_name='Type')),
        ...
        migrations.AddConstraint(
            model_name='quantitysample',
            constraint=models.CheckConstraint(check=models.Q(('type__in', ['BM', 'TMP', 'HR', 'HRV', 'SPO2', 'BP'])), name='health_data_quantitysample_type_valid'),
        ),
    ]
