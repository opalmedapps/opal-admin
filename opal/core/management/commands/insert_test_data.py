...
def _create_test_data(institution_option: InstitutionOption) -> None:
    ...
    if not is_pediatric:
        ...
        _create_pathology_result(
            patient=marge,
            site=sites['RVH'],
            collected_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=2)),
            received_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=2)),
            reported_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=2)),
            legacy_document_id=7,
        )
        _create_pathology_result(
            patient=marge,
            site=sites['RVH'],
            collected_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=12)),
            received_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=12)),
            reported_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=12)),
        ...
        _create_pathology_result(
            patient=homer,
            site=sites['MGH'],
            collected_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=8)),
            received_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=8)),
            reported_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=8)),
        ...
        _create_pathology_result(
            patient=fred,
            site=sites['RVH'],
            collected_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=4)),
            received_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=4)),
            reported_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=4)),
        ...
        _create_pathology_result(
            patient=bart,
            site=sites['MCH'],
            collected_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=5)),
            received_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=5)),
            reported_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=5)),
        ...
        _create_pathology_result(
            patient=wednesday,
            site=sites['RVH'],
            collected_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=15)),
            received_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=15)),
            reported_at=timezone.make_aware(datetime.now() - relativedelta(years=0, months=0, days=15)),
