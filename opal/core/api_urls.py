...
from opal.patients.api.views import CaregiverView, RetrieveRegistrationDetailsView
...
urlpatterns = [
    ...
    path('patients/legacy/<int:legacy_patient_id>/caregivers/', CaregiverView.as_view(), name='caregivers-list'),
