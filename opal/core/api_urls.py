...
from opal.patients.api.views import GetCaregiverList, RetrieveRegistrationDetailsView
...
urlpatterns = [
    ...
    path('patients/legacy/<int:legacy_patient_id>/caregivers/', GetCaregiverList.as_view(), name='caregivers-list'),
