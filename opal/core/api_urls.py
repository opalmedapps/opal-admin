...
from opal.caregivers.api.views import GetRegistrationEncryptionInfo
...
urlpatterns = [
    ...
    path('registration/by-hash/<str:hash>/', GetRegistrationEncryptionInfo.as_view(), name='registration-by-hash'),
