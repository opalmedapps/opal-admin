# Generated by Django 4.1.13 on 2024-01-03 15:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(default='R', max_length=10)),
                ...
                ('give_code', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pharmacy_encoded_order_give_code', to='pharmacy.codedelement')),
                ('give_dosage_form', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pharmacy_encoded_order_give_dosage_form', to='pharmacy.codedelement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('component_type', models.CharField(choices=[('A', 'Additive'), ('B', 'Base'), ('T', 'Text/Instruction')], max_length=1)),
