# Generated by Django 4.1.13 on 2024-02-20 20:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pharmacy_encoded_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pharmacy_route', to='pharmacy.pharmacyencodedorder')),
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pharmacy_encoded_order_physician_prescription_order', to='pharmacy.physicianprescriptionorder'),
        ),
        migrations.AddField(
            model_name='pharmacyencodedorder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pharmacy_encoded_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pharmacy_components', to='pharmacy.pharmacyencodedorder')),
            ],
            options={
