"""Module providing business logic for generating pathology PDF reports using fpdf2 library."""
...
class PathologyPDF(common.ReportPDF):  # noqa: WPS214
    ...
    def __init__(
        ...
        """
        super().__init__(institution_data, patient_data, site_data, report_data)
        self.institution_data = institution_data
        self.site_data = site_data
        self.patient_data = patient_data
        self.pathology_data = report_data
